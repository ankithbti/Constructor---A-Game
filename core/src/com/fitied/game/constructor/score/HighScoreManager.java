package com.fitied.game.constructor.score;
...
public class HighScoreManager {
	...
	private void retrieveHighScores() {
		...
		if (highScoresFile.exists()) {
			...
			try {
				...
				Gdx.app.error(HighScoreManager.class.getName(), "Unable to parse high scores data file", e);
			}
		}
	...
	public static List<HighScore> deserialize(String scoresStr) {
		...
		try {
			...
			Gdx.app.error(HighScoreManager.class.getName(), "Unable to deserialize high scores", e);
		}
		return null;
	}
}
