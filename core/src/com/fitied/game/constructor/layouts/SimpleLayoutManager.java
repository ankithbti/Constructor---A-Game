package com.fitied.game.constructor.layouts;

import java.util.ArrayList;
import java.util.List;

import com.badlogic.gdx.graphics.g2d.SpriteBatch;
import com.fitied.game.constructor.layouts.AbstractLayoutItem;
...
public class SimpleLayoutManager {
	...
	public void addBelow(AbstractLayoutItem li, AbstractLayoutItem topLi, int flags, Margin margin) {
		layoutItems.add(li);
	...
	public void addRight(AbstractLayoutItem li, AbstractLayoutItem leftLi, int flags, Margin margin) {
		layoutItems.add(li);
